...
HD_PWD='C:/Users/giorg/Desktop/progetto-psd/vivado/progetto-psd/progetto-psd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FilterCircuit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FilterCircuit.tcl -notrace
