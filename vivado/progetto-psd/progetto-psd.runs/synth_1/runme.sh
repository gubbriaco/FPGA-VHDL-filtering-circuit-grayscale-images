...
HD_PWD='C:/Users/giorg/Desktop/progetto-psd/vivado/progetto-psd/progetto-psd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FilterCircuit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FilterCircuit.tcl
